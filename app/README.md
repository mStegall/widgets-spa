...
To run the project just `npm install` and `npm start`.  I chose to do the project with React because I wanted to test out creat-react-app and play with the new version of React-Router.  I chose to not use a state management library like Redux or MobX because they felt like overkill for a simple application like this though I am familiar with both.  I chose to use fetch for xhr, though there is no polyfill which would be required for browser compatability.

I did not write unit tests partially because this is a small project and partially because I am not familiar with Jest, though I am familiar with unit testing and TDD.
